...
const uint8 RSP_PRIVATE_KEY = 14;
const uint8 RSP_DISABLED = 15;
const uint8 RSP_CONTACT_MSG_RECV_V3 = 16;
const uint8 RSP_CHANNEL_INFO = 18;
const uint8 RSP_CHANNEL_MSG_RECV_V3 = 17;
const uint8 RSP_SIGN_START = 19;
const uint8 RSP_SIGNATURE = 20;
...
const uint8 PUSH_LOG_RX_DATA = 0x88;	// Not in wiki but confirmed active in firmware (radio log mode)
...
const uint8 PUSH_PATH_DISCOVERY = 0x8D;
const uint8 PUSH_CONTROL_DATA = 0x8E;
const uint8 PUSH_CONTACT_DELETED = 0x8F;
const uint8 PUSH_CONTACTS_FULL = 0x90;
